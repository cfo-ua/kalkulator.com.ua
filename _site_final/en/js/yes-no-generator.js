document.addEventListener('DOMContentLoaded', function() {
    ...
    let stats = {
        yes: parseInt(localStorage.getItem('yesNoStats_yes_en') || '0'),
        no: parseInt(localStorage.getItem('yesNoStats_no_en') || '0'),
        total: parseInt(localStorage.getItem('yesNoStats_total_en') || '0')
    };
    ...
    function generateAnswer() {
        ...
        generateBtn.innerHTML = '<span class="button-icon">⏳</span><span class="button-text">Thinking...</span>';
        ...
        setTimeout(() => {
            ...
            resultText.innerHTML = `
                ...
                <p><strong>Answer:</strong> <span style="font-size: 1.5em; ${isYes ? 'color: #28a745;' : 'color: #dc3545;'}">${answer}</span></p>
            `;
            ...
            generateBtn.innerHTML = '<span class="button-icon">🎯</span><span class="button-text">Get Answer</span>';
    ...
    function saveStats() {
        localStorage.setItem('yesNoStats_yes_en', stats.yes.toString());
        localStorage.setItem('yesNoStats_no_en', stats.no.toString());
        localStorage.setItem('yesNoStats_total_en', stats.total.toString());
    }
    ...
    function resetStatistics() {
        if (confirm('Are you sure you want to reset the statistics?')) {
            ...
            resultText.innerHTML = '<p>Ask a question and press the button!</p>';
        }
    }
