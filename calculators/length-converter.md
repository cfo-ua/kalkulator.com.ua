...
seo:
  ...
  keywords:
    ...
    - будівельні розрахунки довжини
    - інженерні одиниці довжини
    - архітектурні розміри конвертер
    - кройка і шиття розміри
    - спортивні дистанції калькулятор
    - географічні відстані переклад
    - науковий конвертер довжини
    - міжнародні одиниці довжини
    - точні вимірювання довжини
    - креслення розміри калькулятор
  content: |
