...
<form id="visa-checklist-form" autocomplete="off">
  <div class="form-section">
    <h3>🌍 Study Destination & Program</h3>
    <label>
    ...
    <label>
      Study level:
      <select id="study-level" required>
    ...
    <label>
      Program duration:
      <select id="program-duration" required>
        <option value="">Select duration...</option>
        <option value="short">Less than 6 months</option>
        <option value="1-year">6 months - 1 year</option>
        <option value="2-years">1-2 years</option>
        <option value="3-years">2-3 years</option>
        <option value="4-years">3-4 years</option>
  ...
  <div class="form-section">
    ...
    <label>
      ...
      <select id="education-status" required>
        <option value="">Select status...</option>
        <option value="high-school-student">Current high school student</option>
        <option value="high-school-graduate">High school graduate</option>
        <option value="university-student">Current university student</option>
    ...
    <label>
      ...
      <select id="english-test" required>
        ...
        <option value="waived">Test waived by university</option>
      </select>
    </label>
    
    <div class="checkbox-group">
      <label>
        <input type="checkbox" id="have-acceptance"> Already have university acceptance letter
      </label>
      <label>
        <input type="checkbox" id="need-transcripts"> Need official transcripts from previous schools
      </label>
      <label>
        <input type="checkbox" id="need-credential-evaluation"> May need credential evaluation/recognition
      </label>
    </div>
  </div>
  ...
  <div class="form-section">
    ...
    <label>
      ...
      <select id="funding-source" required>
        ...
        <option value="self-funded">Self/family funded</option>
        ...
        <option value="mixed">Multiple funding sources</option>
      </select>
    </label>
    
    <label>
      Estimated total study costs:
      <select id="study-costs" required>
        <option value="">Select cost range...</option>
        <option value="under-25k">Under $25,000/year</option>
        <option value="25k-50k">$25,000 - $50,000/year</option>
        <option value="50k-75k">$50,000 - $75,000/year</option>
        <option value="over-75k">Over $75,000/year</option>
    ...
    <div class="checkbox-group">
      <label>
        <input type="checkbox" id="have-bank-statements"> Have sufficient bank statements ready
      </label>
      <label>
        <input type="checkbox" id="need-sponsor"> Will have financial sponsor
      </label>
      <label>
        <input type="checkbox" id="scholarship-pending"> Scholarship application pending
      </label>
    </div>
  </div>

  <div class="form-section">
    <h3>🆔 Personal Documents & Health</h3>
    <label>
      Passport status:
      <select id="passport-status" required>
        <option value="">Select passport status...</option>
        <option value="valid-long">Valid passport with 18+ months remaining</option>
        <option value="valid-short">Valid passport with 6-18 months remaining</option>
        <option value="expires-soon">Passport expires within 6 months</option>
        <option value="need-renewal">Need to renew passport</option>
        <option value="need-new">Need to apply for first passport</option>
      </select>
    </label>
    ...
    <label>
      ...
      <select id="visa-history" required>
        ...
        <option value="first-time">First time applying for any visa</option>
        <option value="approved-before">Previous visas approved</option>
        <option value="rejected-before">Previous visa rejections</option>
        <option value="overstayed">Previous overstay issues</option>
      </select>
    </label>
    
    <div class="checkbox-group">
      <label>
        <input type="checkbox" id="health-conditions"> Have health conditions requiring documentation
      </label>
      <label>
        <input type="checkbox" id="vaccinations-needed"> May need specific vaccinations
      </label>
      <label>
        <input type="checkbox" id="criminal-record"> Have criminal record to declare
      </label>
    </div>
  </div>
  ...
  <div class="form-section">
    ...
    <label>
      How soon do you want to apply?
      <select id="application-urgency" required>
        <option value="">Select urgency...</option>
        <option value="asap">ASAP - Need to apply immediately</option>
    ...
    <label>
      ...
      <select id="preparation-status" required>
        <option value="">Select status...</option>
        <option value="just-started">Just started researching</option>
        <option value="gathering-docs">Currently gathering documents</option>
        <option value="almost-ready">Almost ready to apply</option>
        <option value="ready">Ready to submit application</option>
      </select>
    </label>
    
    <div class="checkbox-group">
      <label>
        <input type="checkbox" id="tight-deadline"> Have tight university enrollment deadline
      </label>
      <label>
        <input type="checkbox" id="prefer-professional-help"> Prefer professional immigration help
      </label>
    </div>
  </div>

  <button type="submit">📋 Generate My Visa Checklist</button>
</form>

<div id="visa-checklist-result" class="result"></div>