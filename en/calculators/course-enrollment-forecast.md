...
<form id="course-enrollment-form">
  ...
  <select id="courseQuality" required>
    <option value="basic">Basic (Screen recordings, minimal editing)</option>
    <option value="good" selected>Good (Professional audio/video, structured)</option>
    <option value="premium">Premium (High production, interactive elements)</option>
    <option value="exceptional">Exceptional (Studio quality, advanced features)</option>
  </select>

  <label for="courseNiche">Course Category</label>
  <select id="courseNiche" required>
    <option value="business" selected>Business/Entrepreneurship</option>
  ...
  <label for="instructorExperience">Instructor Experience Level</label>
  <select id="instructorExperience" required>
    <option value="beginner">Beginner (New to teaching)</option>
    <option value="intermediate" selected>Intermediate (Some experience)</option>
    <option value="experienced">Experienced (Established educator)</option>
    <option value="expert">Expert (Industry authority)</option>
  </select>

  <label for="existingAudience">Existing Audience Size</label>
  <select id="existingAudience" required>
    <option value="none">No existing audience</option>
    <option value="small" selected>Small (1K-10K followers/subscribers)</option>
    <option value="medium">Medium (10K-100K followers)</option>
    <option value="large">Large (100K+ followers)</option>
  </select>

  <label for="industryCredibility">Industry Credibility</label>
  <select id="industryCredibility" required>
    <option value="building">Building credibility</option>
    <option value="recognized" selected>Recognized in field</option>
    <option value="established">Established authority</option>
    <option value="renowned">Renowned expert</option>
  </select>
  ...
  <select id="marketingChannels" required>
    <option value="organic">Organic (Content marketing, SEO)</option>
    <option value="social" selected">Social Media Marketing</option>
    <option value="paid">Paid Advertising (Facebook, Google)</option>
    <option value="email">Email Marketing</option>
    <option value="partnerships">Partnerships/Affiliates</option>
    <option value="marketplace">Marketplace Only (Udemy, etc.)</option>
  </select>

  <label for="launchStrategy">Course Launch Strategy</label>
  <select id="launchStrategy" required>
    <option value="soft">Soft Launch (Gradual release)</option>
    <option value="standard" selected>Standard Launch (Planned promotion)</option>
    <option value="intensive">Intensive Launch (Major campaign)</option>
    <option value="evergreen">Evergreen (Always available)</option>
  </select>

  <h3>🎯 Market Conditions</h3>
  <label for="marketDemand">Market Demand Level</label>
  <select id="marketDemand" required>
    <option value="low">Low (Niche topic, limited demand)</option>
    <option value="medium" selected>Medium (Good demand, some competition)</option>
    <option value="high">High (Strong demand, competitive)</option>
    <option value="trending">Trending (Hot topic, high competition)</option>
  </select>

  <label for="competitionLevel">Competition Level</label>
  <select id="competitionLevel" required>
    <option value="low">Low (Few similar courses)</option>
    <option value="medium" selected>Medium (Moderate competition)</option>
    <option value="high">High (Many competitors)</option>
    <option value="saturated">Saturated (Overcrowded market)</option>
  </select>
...
<div id="course-enrollment-result" class="result"></div>
