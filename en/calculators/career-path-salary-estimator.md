...
<form id="career-salary-form" autocomplete="off">
  <div class="form-section">
    <h3>💼 Career & Industry Selection</h3>
    <label>
      Primary Career Field:
      <select id="career-field" required>
        ...
        <option value="construction">🏗️ Construction & Architecture</option>
      </select>
    </label>
    
    <label>
      Specific Role/Specialization:
      <select id="specific-role" required>
        <option value="">Select career field first...</option>
      </select>
    </label>
    ...
    <label>
      ...
      <select id="industry" required>
        ...
        <option value="tech-large">Large Tech Company (FAANG)</option>
        <option value="healthcare-hospital">Hospital/Health System</option>
        <option value="healthcare-private">Private Practice</option>
  ...
  <div class="form-section">
    ...
    <label>
      ...
      <select id="experience-years" required>
        ...
        <option value="0">0 years (Entry level/Recent graduate)</option>
    ...
    <div class="checkbox-group">
      <label>
        <input type="checkbox" id="professional-certs"> Have relevant professional certifications
      </label>
      <label>
        <input type="checkbox" id="advanced-skills"> Have specialized/advanced skills in high demand
      </label>
      <label>
        <input type="checkbox" id="leadership-experience"> Have leadership/management experience
      </label>
    </div>
  </div>
  ...
  <div class="form-section">
    ...
    <label>
      ...
      <select id="location" required>
        ...
        <option value="other-major">Other Major City</option>
        <option value="mid-size">Mid-size City</option>
    ...
    <label>
      ...
      <select id="company-size" required>
        ...
        <option value="small">Small Company (51-200 employees)</option>
        <option value="medium">Medium Company (201-1000 employees)</option>
        <option value="large">Large Company (1000-10000 employees)</option>
    ...
    <label>
      Work Arrangement:
      <select id="work-arrangement" required>
  ...
  <div class="form-section">
    <h3>🎯 Career Goals & Priorities</h3>
    <label>
      Primary Career Goal:
      <select id="career-goal" required>
        <option value="">Select goal...</option>
        <option value="maximize-salary">Maximize salary/compensation</option>
        <option value="work-life-balance">Work-life balance</option>
        <option value="skill-development">Skill development/learning</option>
        <option value="leadership">Leadership opportunities</option>
        <option value="job-security">Job security/stability</option>
        <option value="entrepreneurship">Entrepreneurship potential</option>
        <option value="social-impact">Social impact/meaningful work</option>
        <option value="flexibility">Flexibility/remote work</option>
      </select>
    </label>
    ...
    <label>
      ...
      <select id="risk-tolerance" required>
        ...
        <option value="low">Low - Prefer stability and guaranteed income</option>
        <option value="moderate">Moderate - Balanced approach to risk/reward</option>
        <option value="high">High - Willing to take risks for higher rewards</option>
        <option value="very-high">Very High - Startup equity, commissions, etc.</option>
      </select>
    </label>
    ...
    <div class="checkbox-group">
      <label>
        <input type="checkbox" id="willing-relocate"> Willing to relocate for better opportunities
      </label>
      <label>
        <input type="checkbox" id="considering-career-change"> Considering career change/transition
      </label>
      <label>
        <input type="checkbox" id="interested-management"> Interested in management track
      </label>
    </div>
  </div>

  <button type="submit">💰 Calculate Salary Estimate</button>
</form>

<div id="career-salary-result" class="result"></div>