...
<div class="compliance-assessment-container">
  <div id="assessment-intro" class="assessment-section">
    <div class="insight-card info">
      <h6>🛡️ Cybersecurity Compliance Readiness Assessment</h6>
      <p>Evaluate your organization's cybersecurity compliance readiness across 8 critical areas. This comprehensive assessment helps identify gaps and prioritize security improvements.</p>
      <p><strong>📊 Format:</strong> 40 yes/no questions across 8 security domains<br>
      <strong>⏱️ Time:</strong> Approximately 15-20 minutes<br>
      <strong>🎯 Outcome:</strong> Detailed scorecard with recommendations</p>
      <button id="start-assessment" class="start-button">🚀 Start Assessment</button>
    </div>
  </div>
  ...
  <div id="assessment-questions" class="assessment-section" style="display: none;">
    <div class="assessment-progress">
      ...
      <span id="question-counter">Question 1 of 40</span>
    </div>
    ...
    <div class="assessment-navigation">
      ...
      <button id="submit-assessment" class="submit-button" style="display: none;">✅ Complete Assessment</button>
    </div>
  </div>
  ...
  <div id="assessment-results" class="assessment-section" style="display: none;">
      ...
      <div class="insight-card info">
        ...
        <div id="score-summary">
          ...
          <div class="summary-item">
            ...
            <span id="completed-questions">40</span>
          </div>
          <div class="summary-item">
            <span>Priority Actions:</span>
            <span id="priority-count">0</span>
          </div>
        </div>
      </div>
    </div>

    <div id="domain-scores" class="domain-scores">
      <!-- Domain scores will be inserted here -->
    </div>
    ...
    <div class="assessment-actions">
      <button id="retake-assessment" class="action-button">🔄 Retake Assessment</button>
      <button id="print-results" class="action-button">🖨️ Print Results</button>
    </div>
  </div>
</div>
...
.answer-option.yes label {
  border-color: #28a745;
}

.answer-option.yes input[type="radio"]:checked + .answer-text {
  background: #28a745;
  border-color: #28a745;
}

.answer-option.no label {
  border-color: #dc3545;
}

.answer-option.no input[type="radio"]:checked + .answer-text {
  background: #dc3545;
  border-color: #dc3545;
}
...
.domain-status.needs-improvement {
  color: #ffc107;
}
...
@media print {
  .assessment-navigation, .assessment-actions, .start-button {
