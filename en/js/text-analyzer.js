document.addEventListener("DOMContentLoaded", function () {
  ...
  function analyzeText() {
    ...
    // Update display
    lettersCount.textContent = lettersTotal.toLocaleString();
    charsTotalCount.textContent = charsTotal.toLocaleString();
    charsNoSpacesCount.textContent = charsNoSpaces.toLocaleString();
    wordsCount.textContent = wordsTotal.toLocaleString();
    sentencesCount.textContent = sentencesTotal.toLocaleString();
    paragraphsCount.textContent = paragraphsTotal.toLocaleString();
    avgWordsPerSentence.textContent = avgWords;
    avgSentencesPerParagraph.textContent = avgSentences;
  }
