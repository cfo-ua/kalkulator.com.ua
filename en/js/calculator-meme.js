document.addEventListener("DOMContentLoaded", function () {
  ...
  const memeTemplates = [
    {
      ...
      description: "When you see a new calculator",
      placeholder: "👩‍💻📱",
      text: "DISTRACTED\nGIRLFRIEND"
    },
    {
      id: 2,
      name: "Drake Pointing",
      description: "Manual calculations vs calculator",
      placeholder: "🤚🫵",
      text: "DRAKE\nPOINTING"
    },
    {
      id: 3,
      name: "Chef's Kiss",
      description: "When calculator works perfectly",
      placeholder: "👨‍🍳💋",
      text: "CHEF'S\nKISS"
    },
    {
    ...
    },
    {
      ...
      description: "Me vs my calculator",
      placeholder: "😾👩‍💼",
      text: "WOMAN\nYELLING"
    },
    {
      id: 6,
      name: "Two Buttons",
      description: "Use calculator or calculate manually",
      placeholder: "😰🔴🔵",
      text: "TWO\nBUTTONS"
    },
    {
      id: 7,
      name: "This is Fine",
      description: "When the answer is correct",
      placeholder: "🐕🔥",
      text: "THIS IS\nFINE"
    },
    {
      id: 8,
      name: "Galaxy Brain",
      description: "Levels of understanding math",
      placeholder: "🌌🧠",
      text: "GALAXY\nBRAIN"
    },
    {
      ...
      description: "Calculators pointing at each other",
      placeholder: "🕷️👈👈",
      text: "SPIDER-MAN\nPOINTING"
    },
    {
      ...
      description: "When calculator gives wrong answer",
      placeholder: "😱🐱",
      text: "SURPRISED\nPIKACHU"
    },
    {
    ...
    },
    {
      id: 12,
      name: "Confused Math",
      description: "When you don't understand math",
      placeholder: "🤨❓",
      text: "CONFUSED\nMATH"
    },
    {
      ...
      description: "When calculation was simple all along",
      placeholder: "😎💯",
      text: "ALWAYS HAS\nBEEN"
    },
    {
    ...
    },
    {
      id: 15,
      name: "Stonks",
      description: "Calculator math goes up",
      placeholder: "📈📊",
      text: "STONKS\nNOT STONKS"
    },
    {
      id: 16,
      name: "Panik Kalm",
      description: "When calculator breaks",
      placeholder: "😰📱",
      text: "PANIK\nKALM"
    },
    {
      id: 17,
      name: "Dad Math",
      description: "Parents helping with math",
      placeholder: "👨‍👦➗",
      text: "DAD\nMATH"
    },
    {
      id: 18,
      name: "We Have At Home",
      description: "When everyone's a mathematician",
      placeholder: "🏠🧮",
      text: "WE HAVE\nAT HOME"
    },
    {
    ...
    },
    {
      id: 20,
      name: "Guess I'll Die",
      description: "When math is too complex",
      placeholder: "🤷‍♂️💭",
      text: "GUESS I'LL\nDIE"
    }
  ];
  ...
  document.getElementById('download-btn').addEventListener('click', function() {
    ...
    link.download = `calculator-meme-${selectedTemplate.id}-${Date.now()}.png`;
