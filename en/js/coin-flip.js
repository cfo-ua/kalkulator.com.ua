document.addEventListener("DOMContentLoaded", () => {
  ...
  function flipCoin() {
    ...
    flipBtn.querySelector('.button-text').textContent = "Flipping...";
    ...
    setTimeout(() => {
      ...
      result.innerHTML = `
        ...
        <small>Click again to flip once more</small>
      `;
      ...
      flipBtn.querySelector('.button-text').textContent = "Flip Again";
  ...
  function loadStats() {
    try {
      const savedStats = localStorage.getItem('coinFlipStatsEN');
      if (savedStats) {
  ...
  function saveStats() {
    try {
      localStorage.setItem('coinFlipStatsEN', JSON.stringify(stats));
    } catch (error) {
  ...
  function resetStats() {
    if (confirm('Reset all flip statistics?')) {
