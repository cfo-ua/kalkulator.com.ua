  ...
  function updateTrigValues(degrees) {
    ...
    result.innerHTML = `
      <div class="trig-calculations">
        <h4>🧮 Trigonometric Values for ${degrees}°</h4>
        <div class="conversion-result">
          <span><strong>${degrees}°</strong> = <strong>${radText}</strong> radians</span>
        </div>
        <hr>
        <div class="trig-functions">
          <div class="primary-functions">
            <h5>Primary Functions:</h5>
        ...
        <div class="angle-info">
          <h5>🎯 Angle Information:</h5>
          <div class="info-grid">
            <span>Quadrant: <strong>${getQuadrant(normalizedDeg)}</strong></span>
            <span>Reference Angle: <strong>${getReferenceAngle(normalizedDeg)}°</strong></span>
            <span>Coterminal Angle: <strong>${normalizedDeg}°</strong></span>
          </div>
        </div>
      </div>
    `;
