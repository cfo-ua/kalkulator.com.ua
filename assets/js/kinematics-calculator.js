      ...
      if (known.length < 3) {
        result.innerHTML = `
          <div class="insight-card warning">
            ...
            <p>Введіть принаймні 3 відомі величини для розрахунку</p>
          </div>
        `;
        return;
      }
  ...
  function displayResults(results) {
    ...
    html += `
      <div style="margin-top: 2rem;">
        <h4>📋 Використані рівняння:</h4>
        <ul>
          <li><strong>v = v₀ + at</strong> - для знаходження швидкості</li>
          <li><strong>s = v₀t + ½at²</strong> - для знаходження переміщення</li>
          <li><strong>v² = v₀² + 2as</strong> - зв'язок швидкості та переміщення</li>
        </ul>
      </div>
    `;
