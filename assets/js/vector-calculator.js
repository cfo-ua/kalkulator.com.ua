  ...
  buttons.unit.addEventListener('click', function() {
    ...
    result.innerHTML = `
      ...
      <div style="margin-top: 1rem; padding: 1rem; background: #f8f9fa; border-radius: 8px;">
        <strong>Примітка:</strong> Одиничний вектор має ту ж саму напрямок, що й оригінальний вектор, але довжину 1.
      </div>
    `;
  });
